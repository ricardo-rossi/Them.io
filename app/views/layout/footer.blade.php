    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <div class="content">
            <p>
            Info: <a href="#">info@them.io</a><br/>
            Support: <a href="#">support@them.io</a>
            </p>
          </div>
        </div>
        <!-- Social icons -->
        <div class="col-sm-4">
          <h3 class="text-color"><span>Stay in touch</span></h3>
      ...
      <div class="row">
        <div class="col-sm-12">
          <p>&copy; Them.io 2014. <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a></p>
        </div>
      </div>
    </div>
  </footer>