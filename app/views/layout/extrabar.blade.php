      ...
      <div class="row">
            ...
            <form role="form">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="polls">
                  @include('editors.partials.poll')
                </div>
                <div class="tab-pane" id="quizzes">
                  @include('editors.partials.quiz')
                </div>
                <div class="tab-pane" id="ratings">
                 @include('editors.partials.rating')
                </div>
                <div class="tab-pane" id="votes">
                 @include('editors.partials.vote')
                </div>
                <div class="tab-pane" id="shares">
                 @include('editors.partials.share')
                </div>
              </div>
           </form>
          </div>
        ...
        <div class="col-md-5">
            <div class="sign-form animated bounceInRight extra-right">
              <h3 class="first-child text-center">Sign Up / or <a href="/login">Login</a></h3>
              <form role="form">
